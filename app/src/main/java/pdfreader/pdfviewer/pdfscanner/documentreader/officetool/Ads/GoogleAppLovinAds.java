...
public class GoogleAppLovinAds {
    ...
    public static void preLoadAds(Activity activity) {
        if (!(Preference.getActive_Weekly().equals("true") || Preference.getActive_Monthly().equals("true") || Preference.getActive_Yearly().equals("true"))) {
            if (Preference.getAds_name().equals("a")) {
    ...
    public static void preLoadFull(Activity activity) {
        ...
        InterstitialAd.load(activity, Preference.getGoogle_full(), adRequest,
    ...
    public static void preLoadAppLovinFull(Activity activity) {
        maxInterstitialAd = new MaxInterstitialAd(Preference.getAppLovin_full(), activity);
    ...
    public static void preLoadBanner(Activity activity) {
        ...
        adView.setAdUnitId(Preference.getGoogle_banner());
    ...
    public static void preLoadAppLovinBanner(Activity activity) {
        maxAdView = new MaxAdView(Preference.getAppLovin_banner(), activity);
    ...
    public static void preLoadNative(Activity activity) {
        AdLoader.Builder builder = new AdLoader.Builder(activity, Preference.getGoogle_native()).forNativeAd(nativeAd -> {
            mNativeAd = nativeAd;
    ...
    public static void preLoadApLovinNative(Activity activity) {
        ...
        nativeAdLoader = new MaxNativeAdLoader(Preference.getAppLovin_native(), activity);
